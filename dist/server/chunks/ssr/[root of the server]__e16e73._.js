...
const login = ({ seoData })=>{
    ...
    const { authAdmin } = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useContext"])(__TURBOPACK__imported__module__$5b$project$5d2f$context$2f$authContext$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["default"]);
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        if (authAdmin.isAuth) {
            router.push("/admin");
        }
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:8080/")}api/admin/login`, {
                email,
                password
            });
            if (res.data.success) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e16e73._.js.map