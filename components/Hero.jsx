...
// import MainVideo from "/main-bg-video.mp4"; // Update this path to your video file
...
const Hero = () => {
  ...
  // Word split animation with scroll-based reset
  const headingVariants = {
    ...
    visible: {
      ...
      transition: {
        staggerChildren: 0.1,
        delayChildren: 0.2,
        // When heading animation completes, trigger paragraph animation
        onComplete: () => {
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          opacity: 1 - scrollY / 500, // Fade out background as user scrolls
        }}
      >
