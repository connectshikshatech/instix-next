        ...
        <div className="flex flex-col md:flex-row gap-12 max-w-7xl mx-auto px-4">
          ...
          <div className="md:w-1/2" data-aos="fade-left">
            ...
            <p className="text-gray-300 mb-8 text-justify" data-aos="slide-up">
              ...
              Request for Stream (RFS) and Principal Liquidity (LP) allowing
              large ticket sized orders execution with zero transaction fees.
              Licensed in Poland, instiX Platform offers seamless trading
              experience with 24/7 customer support and instant withdrawals,
